...
SELECT COUNT(*) AS INVOICES, BillingCity  FROM invoices
...
SELECT COUNT(*) AS CUSTOMERS_COUNT, City  FROM customers c 
GROUP BY City 
ORDER BY COUNT(*) DESC 
LIMIT 5;
...
SELECT FirstName, LastName, Email, Phone, t.GenreId 
FROM customers c 
JOIN invoices i  
ON c.customerid = i.CustomerId 
JOIN invoice_items ii 
