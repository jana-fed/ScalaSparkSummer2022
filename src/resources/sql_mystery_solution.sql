...
--. She has red hair and she drives a Tesla Model S. 
-- I know that she attended the SQL Symphony Concert 3 times in December 2017.
SELECT person_id , COUNT(person_id) as attends  FROM facebook_event_checkin fec
WHERE fec.event_name LIKE '%Symphony Concert%'
AND date LIKE '%201712%'
GROUP BY  person_id
ORDER by attends DESC
LIMIT 2;


SELECT * FROM drivers_license dl WHERE 
dl.hair_color = 'red' 
...
INSERT Into solution (value)
values('Miranda Priestly');
